...
VOID OpenGui()
{
	...
	wc.lpszClassName = "ReaxusWindow";
	RegisterClassEx(&wc);
	MainScriptWindow = CreateWindowEx(WS_EX_TOPMOST, "ReaxusWindow", "Reaxus", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX, 0, 0, 395, 405, NULL, NULL, hInstance, NULL);
